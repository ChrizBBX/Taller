...
function RepuestosCreate (){
    ...
    const CreateAction = (event) => {
        ...
        setValidated(true)
        event.preventDefault()
        if(respDescripcion != '' && respPrecio != '' && provID != '' && marcID != '' && respStock != '' && respAnio >= 1960 && respAnio <= 2023){
            let payload = {
    ...
    return(
        <div className='card' style={{backgroundColor: 'white'}}>
            <div className='card-header'><h1>Nuevo Repuesto</h1></div>
...
export default RepuestosCreate