...
const EditarEmpleado = () => {
    ...
    const Editar = (e) => {
            ...
            !EstadoCivil || !Deparatemento || !Municipio || !Dirrecion ||!Telefono || !Sucursal || !Cargo) 
        {
            ...
            const fechaNacimiento = new Date(FechaNac).toLocaleDateString('es-ES', {day: '2-digit', month: '2-digit', year: 'numeric'});
            const fechaNacimientoISO = new Date(fechaNacimiento.split('/').reverse().join('-')).toISOString();
            ...
            let empleado111 = {
                ...
                empe_FechaNacimiento: fechaNacimientoISO,
                empe_Sexo: Sexo,
