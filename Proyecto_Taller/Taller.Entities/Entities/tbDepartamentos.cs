...
namespace Taller.Entities.Entities
{
    public partial class tbDepartamentos
    {
        ...
        public int depa_UserCreacion { get; set; }
        public DateTime depa_FechaCreacion { get; set; }
        public int? depa_UserModificacion { get; set; }
        public DateTime? depa_FechaModificacion { get; set; }
        public bool? depa_Estado { get; set; }

        public virtual tbUsuarios depa_UserCreacionNavigation { get; set; }
        public virtual tbUsuarios depa_UserModificacionNavigation { get; set; }
